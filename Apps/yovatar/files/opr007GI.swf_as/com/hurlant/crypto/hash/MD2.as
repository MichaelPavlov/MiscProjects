package com.hurlant.crypto.hash 
{
    ...
    public class MD2 extends Object implements com.hurlant.crypto.hash.IHash
    {
        ...
        public function hash(arg1:flash.utils.ByteArray):flash.utils.ByteArray
        {
            ...
            loc10 = 0;
            loc2 = arg1.length;
            loc3 = 16 - arg1.length % 16 || 16;
            do 
            {
                arg1[arg1.length] = loc3;
            }
            ...
            while (loc3 < loc4) 
            {
                ...
                while (loc8 < 16) 
                {
                    loc5[loc8] = loc11 = loc5[loc8] ^ S[(arg1[(loc3 + loc8)] ^ loc6)];
                    loc6 = loc11;
                    loc8 = (loc8 + 1);
                }
                loc3 = loc3 + 16;
            ...
            while (loc3 < loc4) 
            {
                ...
                while (loc8 < 16) 
                {
                    loc7[(16 + loc8)] = loc11 = arg1[(loc3 + loc8)];
                    loc7[(32 + loc8)] = loc11 ^ loc7[loc8];
                    loc8 = (loc8 + 1);
                }
                loc9 = 0;
                loc8 = 0;
