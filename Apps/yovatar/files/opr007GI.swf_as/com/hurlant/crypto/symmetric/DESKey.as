package com.hurlant.crypto.symmetric 
{
    ...
    public class DESKey extends Object implements com.hurlant.crypto.symmetric.ISymmetricKey
    {
        ...
        protected function generateWorkingKey(arg1:Boolean, arg2:flash.utils.ByteArray, arg3:uint):Array
        {
            ...
            {
                loc7 = pc1[loc8];
                loc5[loc8] = !((arg2[(arg3 + (loc7 >>> 3))] & bytebit[(loc7 & 7)]) == 0);
                loc8 = (loc8 + 1);
            }
            loc9 = 0;
            while (loc9 < 16) 
            {
                ...
                while (loc8 < 28) 
                {
                    if ((loc7 = loc8 + totrot[loc9]) < 28)
                    {
                        loc6[loc8] = loc5[loc7];
                    }
                    else 
                    {
                        loc6[loc8] = loc5[(loc7 - 28)];
                    }
                    loc8 = (loc8 + 1);
                }
                loc8 = 28;
                ...
                while (loc8 < 24) 
                {
                    if (loc6[pc2[loc8]])
                    {
                        loc4[loc10] = loc4[loc10] | bigbyte[loc8];
                    }
                    if (loc6[pc2[(loc8 + 24)]])
                    {
                        loc4[loc11] = loc4[loc11] | bigbyte[loc8];
                    }
                    loc8 = (loc8 + 1);
                }
                loc9 = (loc9 + 1);
            ...
            while (loc9 != 32) 
            {
                loc12 = loc4[loc9];
                loc13 = loc4[(loc9 + 1)];
                loc4[loc9] = (loc12 & 16515072) << 6 | (loc12 & 4032) << 10 | (loc13 & 16515072) >>> 10 | (loc13 & 4032) >>> 6;
                loc4[(loc9 + 1)] = (loc12 & 258048) << 12 | (loc12 & 63) << 16 | (loc13 & 258048) >>> 4 | loc13 & 63;
                loc9 = loc9 + 2;
            }
            return loc4;
        }
        ...
        protected function desFunc(arg1:Array, arg2:flash.utils.ByteArray, arg3:uint, arg4:flash.utils.ByteArray, arg5:uint):void
        {
            ...
            loc8 = 0;
            loc10 = 0;
            loc8 = (loc8 = (loc8 = (loc8 = (arg2[(arg3 + 0)] & 255) << 24) | (arg2[(arg3 + 1)] & 255) << 16) | (arg2[(arg3 + 2)] & 255) << 8) | arg2[(arg3 + 3)] & 255;
            loc7 = (loc7 = (loc7 = (loc7 = (arg2[(arg3 + 4)] & 255) << 24) | (arg2[(arg3 + 5)] & 255) << 16) | (arg2[(arg3 + 6)] & 255) << 8) | arg2[(arg3 + 7)] & 255;
            loc6 = (loc8 >>> 4 ^ loc7) & 252645135;
            loc7 = loc7 ^ loc6;
            loc6 = ((loc8 = loc8 ^ loc6 << 4) >>> 16 ^ loc7) & 65535;
            loc7 = loc7 ^ loc6;
            loc8 = loc8 ^ loc6 << 16;
            loc6 = (loc7 >>> 2 ^ loc8) & 858993459;
            loc8 = loc8 ^ loc6;
            loc6 = ((loc7 = loc7 ^ loc6 << 2) >>> 8 ^ loc8) & 16711935;
            loc8 = loc8 ^ loc6;
            loc7 = ((loc7 = loc7 ^ loc6 << 8) << 1 | loc7 >>> 31 & 1) & 4294967295;
            loc6 = (loc8 ^ loc7) & 2863311530;
            loc8 = loc8 ^ loc6;
            loc7 = loc7 ^ loc6;
            loc8 = (loc8 << 1 | loc8 >>> 31 & 1) & 4294967295;
            loc9 = 0;
            while (loc9 < 8) 
            {
                loc6 = (loc6 = loc7 << 28 | loc7 >>> 4) ^ arg1[(loc9 * 4 + 0)];
                loc10 = (loc10 = (loc10 = (loc10 = SP7[(loc6 & 63)]) | SP5[(loc6 >>> 8 & 63)]) | SP3[(loc6 >>> 16 & 63)]) | SP1[(loc6 >>> 24 & 63)];
                loc6 = loc7 ^ arg1[(loc9 * 4 + 1)];
                loc10 = (loc10 = (loc10 = (loc10 = loc10 | SP8[(loc6 & 63)]) | SP6[(loc6 >>> 8 & 63)]) | SP4[(loc6 >>> 16 & 63)]) | SP2[(loc6 >>> 24 & 63)];
                loc6 = (loc6 = (loc8 = loc8 ^ loc10) << 28 | loc8 >>> 4) ^ arg1[(loc9 * 4 + 2)];
                loc10 = (loc10 = (loc10 = (loc10 = SP7[(loc6 & 63)]) | SP5[(loc6 >>> 8 & 63)]) | SP3[(loc6 >>> 16 & 63)]) | SP1[(loc6 >>> 24 & 63)];
                loc6 = loc8 ^ arg1[(loc9 * 4 + 3)];
                loc10 = (loc10 = (loc10 = (loc10 = loc10 | SP8[(loc6 & 63)]) | SP6[(loc6 >>> 8 & 63)]) | SP4[(loc6 >>> 16 & 63)]) | SP2[(loc6 >>> 24 & 63)];
                loc7 = loc7 ^ loc10;
                loc9 = (loc9 + 1);
            }
            ...
            loc8 = loc8 ^ loc6;
            loc7 = loc7 ^ loc6;
            loc6 = ((loc8 = loc8 << 31 | loc8 >>> 1) >>> 8 ^ loc7) & 16711935;
            loc7 = loc7 ^ loc6;
            loc6 = ((loc8 = loc8 ^ loc6 << 8) >>> 2 ^ loc7) & 858993459;
            loc7 = loc7 ^ loc6;
            loc8 = loc8 ^ loc6 << 2;
            loc6 = (loc7 >>> 16 ^ loc8) & 65535;
            loc8 = loc8 ^ loc6;
            loc6 = ((loc7 = loc7 ^ loc6 << 16) >>> 4 ^ loc8) & 252645135;
            loc8 = loc8 ^ loc6;
            loc7 = loc7 ^ loc6 << 4;
            arg4[(arg5 + 0)] = loc7 >>> 24 & 255;
            arg4[(arg5 + 1)] = loc7 >>> 16 & 255;
            arg4[(arg5 + 2)] = loc7 >>> 8 & 255;
            arg4[(arg5 + 3)] = loc7 & 255;
            arg4[(arg5 + 4)] = loc8 >>> 24 & 255;
            arg4[(arg5 + 5)] = loc8 >>> 16 & 255;
            arg4[(arg5 + 6)] = loc8 >>> 8 & 255;
            arg4[(arg5 + 7)] = loc8 & 255;
            return;
        }
